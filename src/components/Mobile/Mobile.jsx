...
const Mobile = () => {
	...
	return (
		<div
			id="Services"
			className="w-[85%] md:w-[90%] mx-auto min-h-screen py-20">
			<Title
				size={"text-7xl md:text-4xl"}
				width="w-[60%] md:w-[90%]"
				title={`Development of mobile 
            applications`}
			/>
			<div className="flex justify-between items-center md:flex-col-reverse">
				<div className="w-[40%] md:w-full ">
					...
					/>
					<div className="flex w-[80%] flex-wrap mt-4 md:w-full  md:flex-wrap ">
						{data.map((item, i) => (
							<div
								key={i}
								// style={{ width: "140px" }}
								className=" rounded w-[40%] md:w-[120px] md:mr-5 mb-4   md:mb-4 p-2 md:p-1 text-center bg-[#f4f7ff]">
								<img
									src={item.img}
									className="block mx-auto md:w-[40%]"
									alt={item.img}
								/>
								<p className="mt-3 mx-auto font-bold md:text-xs">{item.text}</p>
							</div>
						))}
					</div>
					<h1 className="text-3xl font-semibold mt-12 mb-7 text-gray-600 md:text-center">
						Technologies
					</h1>
					<div className="flex w-[80%] mt-4 md:w-full md:mb-8 flex-wrap ">
						{technologies.map((item, i) => (
							<div
								key={i}
								className="rounded w-[40%] md:w-[120px] md:mr-5 mb-4 p-2 text-center">
								<img
									src={item.img}
									className="block mx-auto"
									alt={item.img}
								/>
								<p className="mt-3 mx-auto font-bold">{item.text}</p>
							</div>
						))}
					</div>
				</div>
				<div
					className="w-[50%] md:w-[60%] my-8"
					style={{
